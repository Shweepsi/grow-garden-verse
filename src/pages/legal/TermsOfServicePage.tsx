      ...
      <div className="container mx-auto max-w-4xl px-4 py-6">
        ...
        <div className="prose prose-sm max-w-none">
          ...
          <section className="mb-6">
            ...
            <p>En utilisant Idle Grow, vous acceptez ces conditions d'utilisation dans leur intégralité.</p>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold mb-3">2. Description du service</h2>
            <p>Idle Grow est un jeu mobile de simulation de jardinage où les joueurs cultivent des plantes virtuelles pour gagner des pièces et progresser.</p>
          </section>
          ...
          <section className="mb-6">
            ...
            <ul className="list-disc pl-6 mt-2">
              <li>Utiliser l'application de manière conforme aux lois applicables</li>
          ...
          <section className="mb-6">
            <h2 className="text-lg font-semibold mb-3">4. Contenu généré par l'utilisateur</h2>
            <p>Tout contenu que vous créez (pseudonymes, données de jeu) reste votre propriété mais vous nous accordez le droit de l'utiliser dans le cadre du service.</p>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold mb-3">5. Limitation de responsabilité</h2>
            <p>Idle Grow est fourni "en l'état" sans garantie. Nous ne sommes pas responsables des pertes de données ou des problèmes techniques.</p>
          </section>
          ...
          <section className="mb-6">
            ...
            <p>Nous pouvons suspendre ou résilier votre accès en cas de violation de ces conditions.</p>
          </section>

          <section className="mb-6">
            <h2 className="text-lg font-semibold mb-3">8. Contact</h2>
            <p>Pour toute question concernant ces conditions : contact@idlegrow.com</p>
          </section>
        </div>
      </div>
    </div>
